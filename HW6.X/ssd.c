...
void ssd1306_drawLetter(unsigned char l, unsigned int lcx, unsigned int lcy) {  // lcx:letter count x
    int Lascii;
    Lascii = (int) (l);
    Lascii = Lascii- 0x20;
    int x=0;
...
//    for (i=0; strlen(mes); i++) 
    ...
    ssd1306_update(); // update after message is completely programmed
